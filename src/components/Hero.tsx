        ...
        <section className="relative h-screen w-full overflow-hidden flex items-end pb-20 md:pb-32 px-6 md:px-20">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end">
                <motion.div
                    ...
                    className="text-left"
                >
                    <h1 className="text-5xl md:text-8xl font-serif text-white tracking-wide mb-4 drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
                        rel!c
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-300 font-light tracking-widest uppercase drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
